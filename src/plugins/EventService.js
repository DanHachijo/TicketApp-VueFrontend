...
// WorldPayDoc worldpay-doc/
  ...
  getEstimateProduct(prj, ver, type){
    return apiClient.get(`estimate-product/?project__prj_number=${prj}&project__ver=${ver}&product__product_type=${type}`);
  },
  getAllEstimateProduct(prj, ver){
    return apiClient.get(`estimate-product/?project__prj_number=${prj}&project__ver=${ver}`);
  },
  getEstimateProductByVendor(prj, ver, vendorId){
    return apiClient.get(`estimate-product/?project__prj_number=${prj}&project__ver=${ver}&product__vendor=${vendorId}`);
  },
